...
impl Storage {
    ...
    ///
    /// Le point de contrôle vient d'abord : le WAL grossit sans borne entre
    /// deux checkpoints (4 Mo de journal pour 470 ko de base, constaté), et
    /// `VACUUM` seul le laisse tel quel — l'utilisateur compactait sans voir
    /// le poste « Historique » bouger.
